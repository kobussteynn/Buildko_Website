// src/components/AboutSellerSection.jsx
  ...
  return (
    <section className="w-full py-16">
      <div className="mx-auto max-w-7xl px-4 lg:px-6">
        {/* Seller layout: bold dark panel + simple proof bullets */}
          ...
          <div className="grid gap-10 p-8 md:p-10 lg:grid-cols-12 lg:items-center">
            ...
            <div className="lg:col-span-6">
              ...
              <h2 className="mt-4 text-3xl font-semibold tracking-tight md:text-4xl">
                A reliable build partner for{" "}
                <span className="text-teal-300">bigger projects</span>.
              </h2>

              <p className="mt-3 max-w-xl text-white/80">
                If you want a team that keeps the site organised, the programme moving, and the finishes clean,
                let’s talk. Share your plans or brief and we’ll come back with clear next steps.
              </p>
              ...
              <div className="rounded-3xl bg-white/5 p-6 md:p-7">
                ...
                <div className="mt-7 rounded-2xl border border-white/10 bg-white/5 p-4">
                  ...
                  <p className="mt-1 text-sm text-white/75">
                    Tell us what you’re building and where — we’ll guide you on the fastest way to get a clear quote.
                  </p>
                </div>
              </div>
            </div>
