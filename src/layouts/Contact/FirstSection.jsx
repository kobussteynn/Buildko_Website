...
const COMPANY = {
  ...
  // Update these if you want them shown:
  phoneDisplay: "+27 81 586 4848",
        ...
        <div className="grid gap-8 lg:grid-cols-12 lg:items-start">
          ...
          <div className="lg:col-span-7">
            ...
            <div className="mt-6 grid gap-3 sm:grid-cols-3">
              <Button asChild className="rounded-2xl bg-teal-500 text-white hover:bg-teal-600">
                <a
                  href={waHref}
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center justify-center gap-2 py-6 font-semibold"
                >
              ...
              <Button asChild variant="outline" className="rounded-2xl">
                <a href={telHref} className="flex items-center justify-center gap-2 py-6 font-semibold">
              ...
              <Button asChild variant="outline" className="rounded-2xl">
                <a href={mailHref} className="flex items-center justify-center gap-2 py-6 font-semibold">
          ...
          {/* Right: reason picker (pairs nicely with your contact form below) */}
          <div className="lg:col-span-5">
            <Card className="rounded-3xl">
              <CardContent className="p-6 md:p-7">
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center justify-between gap-3">
                          ...
                          <ArrowRight className={active ? "h-4 w-4 text-teal-700" : "h-4 w-4 text-muted-foreground"} />
                        </div>
                      </button>
                    );
                  })}
                ...
                {/* Optional: hidden input idea for your form */}
